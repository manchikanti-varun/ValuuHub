    ...
    return (
        <>
            ...
            `}</style>
                        ...
                        <p
                            className="max-w-2xl mx-auto text-blue-100 mb-2 mt-4 px-4"
                            style={{
                                fontFamily: "var(--font-poppins)",
                                fontSize: "14px",
                                lineHeight: "150%",
                    ...
                    {/* Center section with fixed positioning for both elements */}
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-[250px] h-[300px]">
                        {/* OUR EDGE button with fixed position */}
                        <div className="absolute top-5 left-1/2 transform -translate-x-1/2 z-20">
                            <motion.button
                                onClick={handleGetInTouch}
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="cursor-pointer bg-white text-blue-800 font-semibold py-1.5 px-4 rounded-full text-sm"
                                style={{
                                    fontFamily: "var(--font-poppins)",
                        ...
                        {/* Sphere with fixed position */}
                        <motion.div
                            ref={sphereRef}
                            className={`absolute top-[-350px] left-1/2 transform -translate-x-1/2 cursor-pointer flex items-center justify-center ${hideOriginalSphere ? "opacity-0" : "opacity-100"}`}
                            onClick={handleGetInTouch}
                            whileHover={{
